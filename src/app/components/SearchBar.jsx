...
export default function SearchBar() {
  ...
  return (
    <div className="backdrop-blur-lg bg-black/60 border border-white/10 rounded-2xl shadow-2xl p-6 flex flex-col md:flex-row gap-4 items-center justify-between w-full">
      {/* Type */}
      <select
        className="bg-black/40 text-white placeholder-white border border-white/20 rounded-lg px-4 py-2 w-full md:w-1/5 focus:outline-none"
        value={filters.type}
